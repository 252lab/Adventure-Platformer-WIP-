...
# game icon
# enemies turn when hit tilemap collision/no more tiles beneath them
# might need to switch enemy to characterbody2d?
# add function so player dies when fall in pit
